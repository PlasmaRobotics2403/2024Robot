...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if(driver.RB.isPressed()) {
      ...
      else if(intakeCone && !attemptingConeGrab) {
        robotState = "intakeCone";
      }
    }
      ...
      intakeCone = false;
      grabber.runGrabberNoSensor(-Constants.GrabberConstants.GRABBER_SPEED);
    }
      ...
      switch(robotState){
        ...
        case "intakeCone":
          if(!driver.RB.isPressed()) {
            ...
            grabber.runGrabberNoSensor(Constants.GrabberConstants.GRABBER_SLOW_SPEED);
          }
          break;
        default:
          robotState = "stow";
