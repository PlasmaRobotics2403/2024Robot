...
public class ThreeCenterFar extends AutoMode {
	...
	public ThreeCenterFar(Swerve swerve, StateManager manager, Photon photon) {
		this.swerve = swerve;
        this.manager = manager;
        this.photon = photon;

		pathBlue1 = "ThreeCenterFarBlue1";
        pathRed1 = "ThreeCenterFarRed1";
        pathBlue2 = "ThreeCenterFarBlue2";
        pathRed2 = "ThreeCenterFarRed2";
	}
