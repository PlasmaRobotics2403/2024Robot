...
public class ThreeCenterNear extends AutoMode {
	...
	public ThreeCenterNear(Swerve swerve, StateManager manager, Photon photon) {
		this.swerve = swerve;
        this.manager = manager;
        this.photon = photon;

		pathBlue1 = "ThreeCenterNearBlue1";
        pathRed1 = "ThreeCenterNearRed1";
        pathBlue2 = "ThreeCenterNearBlue2";
        pathRed2 = "ThreeCenterNearRed2";
	}
